...
Vettai is on testnet today, at `https://world-production-4620.up.railway.app`. The mainnet
treasury key, its funding and the final pool numbers are still to be confirmed.
